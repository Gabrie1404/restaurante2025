...
<head>
    <meta charset="UTF-8">
    <title>Pastel bem bolado - Cadastrar Pratos</title>
...
<body>
        ...
        ></div><div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <h4 class="text-white">
                        Para cadastrar um prato, preencha as
                        informações presentes no formulário abaixo
                        corretamente e envie ao sistema clicando no
                        botão “Enviar prato”. <br><br>

                        Verifique as informações antes de enviá-las
                        e boas vendas!
                    </h4>
                    ...
                    <p class="text-white link-nav"><a href="homepage">Início </a> <span
                            class="lnr lnr-arrow-right"></span> <a href="cadastro_pratos">Cadastro de Pratos</a>
                    </p>
                </div>
            </div>
        </div>
    ...
    <form class="formulario-container" action="{{ url('/pratos/cadastrar') }}" method="POST">
        @csrf
        ...
        <div class="formulario-botao">
            <button type="submit" class="primary-btn" value="Enviar Prato">Cadastrar</button>
        </div>
    </form>
