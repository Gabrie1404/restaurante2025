...
<head>
    <meta charset="UTF-8">
    <title>Pastel bem bolado - Início</title>
        ...
        <div class="container">
            <div class="row fullscreen align-items-center justify-content-between">
                <div class="col-lg-12 banner-content">
                    <h1 class="text-white text-center">“Crocante por fora, Irresitível por dentro!”</h1>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 home-about-left">
                    ...
                    <p>
                        Seja bem-vindo, colega! Nossa pastelaria bem bolada 
                        veio para oferecer para vocês os melhores pastéis da região, 
                        unimos tradição e qualidade em cada pastel, 
                        cada mordida é uma experiência que surpreende o paladar.
                    </p>
            ...
            <div class="row d-flex justify-content-center">
                <div class="menu-content pb-70 col-lg-8">
                    <div class="title text-center">
                        <h1 class="mb-10">Precisa cadastrar algo?</h1>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="funcionalidades-area">
                        ...
                        <p>
                            Esta função de cadastro de pedidos permite registrar solicitações de forma eficiente e
                ...
                <div class="col-lg-4">
                    <div class="funcionalidades-area">
                        ...
                        <p>
                            Esta função foi desenvolvido para otimizar o cadastro de ingredientes usados em nossos
                ...
                <div class="col-lg-4">
                    <div class="funcionalidades-area">
                        ...
                        <p>
                            Esta função foi criado para facilitar o cadastro de pratos de maneira prática e organizada.
