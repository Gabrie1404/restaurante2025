...
<head>
    <meta charset="UTF-8">
    <title>Pastel bem bolado - Ingredientes</title>
        ...
        ></div> <div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <h4 class="text-white">
                        Aqui você verá uma lista com seus ingredientes!
                    </h4>

                    <br>

                    <p class="text-white link-nav"><a href="homepage">Início </a> <span
                            class="lnr lnr-arrow-right"></span> <a href="exibir_pratos"> Ingredientes</a></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <tbody>
                    @foreach($ingredientes as $ingrediente)
                        <tr>
                            ...
                            <td>{{ $ingrediente->marca_fornecedor ?? 'N/A' }}</td>
                            <td>{{ $ingrediente->nome }}</td>
                            <td>{{ $ingrediente->quantidade }} {{ $ingrediente->unidade ?? 'un' }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
