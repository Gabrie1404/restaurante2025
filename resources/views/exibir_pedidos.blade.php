...
<head>
    <meta charset="UTF-8">
    <title>Pastel bem bolado - Pedidos</title>
        ...
        ></div><div class="container">
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <h4 class="text-white">
                        Aqui você verá uma lista com seus pedidos!
                    </h4>

                    <br>

                    <p class="text-white link-nav"><a href="homepage">Início </a> <span
                            class="lnr lnr-arrow-right"></span> <a href="exibir_pedidos"> Pedidos</a></p>
                </div>
            </div>
        </div>
    </section>
